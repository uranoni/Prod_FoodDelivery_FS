        ...
        <v-stepper-items>
          <v-stepper-content step="1">
            <v-row>
              ...
              <v-col cols="6">
                <v-text-field label="時間" type="time" outlined v-model="orderTime"></v-text-field>
              </v-col>
          ...
          <v-stepper-content step="2">
            <div>
              <v-row>
                <v-col cols="6">
                  <v-text-field label="店家名稱" outlined>

                  </v-text-field>
                </v-col>
                <v-col cols="6">
                  <v-text-field label="預估等待時間" outlined>
                  </v-text-field>
                </v-col>
                <v-col cols="6">
                  <v-text-field label="品項" outlined>

                  </v-text-field>
                </v-col>
                <v-col cols="6">
                  <v-text-field label="數量" type="number" outlined>
                  </v-text-field>
                </v-col>                  
                <v-col class="text-right">
